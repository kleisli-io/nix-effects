...
in
api.namespace {
  description = "Primitive types: String/Int/Bool/Float/Attrs/Path/Derivation/Function/Null/Unit/Any — universe-0 atomic types corresponding to Nix's value categories.";
  doc = "Primitive types: String, Int, Bool, Float, Attrs, Path, Derivation, Function, Null, Unit, Any.";
  value = {
    String = api.leaf {
      value = String;
